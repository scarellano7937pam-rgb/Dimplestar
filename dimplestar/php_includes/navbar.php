  ...
  <div class="container mx-auto flex justify-between items-center px-6 py-4">
    ...
    <div class="hidden md:flex space-x-4">
      <?php if (isset($_SESSION['user_id'])): ?>
        <span class="flex items-center text-gray-700 mr-4">Hello, <?= htmlspecialchars($_SESSION['name']) ?></span>
        <a href="logout.php" class="px-4 py-2 border border-red-600 text-red-600 rounded-lg hover:bg-red-50">Logout</a>
      <?php else: ?>
